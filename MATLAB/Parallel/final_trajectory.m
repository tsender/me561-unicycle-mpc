...
u=@(t) [interp1(0:dt:149*dt,U(1,:),t,'previous','extrap');...
       interp1(0:dt:149*dt,U(2,:),t,'previous','extrap')];
[T1,Y1]=ode45(@(t,x) odefun(x,u(t)),[0:dt:150*dt],[0 0 0]);
...
function [J, dJ] = costfun(z)
 ...
 for i = 1:nsteps-1
   ...
   %}
    ...
    nom(1:3:3*nsteps) = 1.1;
    nom(2:3:3*nsteps) = -1.2;
    nom(3:3:3*nsteps) = 0 ;
    Q=eye(3*nsteps);
